...
import { forceLogoutAndReset } from '../services/api'; // добавляем импорт
...
export function Login({ onLogin }: LoginProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => { // делаем async
    e.preventDefault();
    setIsLoading(true);
    
    // Очищаем сессию перед новым логином
    await forceLogoutAndReset();
