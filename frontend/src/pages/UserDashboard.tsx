  ...
  return (
    <div className="min-h-screen bg-[#E4E9F8]">
      ...
      <div className="absolute top-4 right-6 z-20">
        <button onClick={onLogout} className="px-4 py-2 bg-[#E36756] hover:bg-[#d55a48] text-white font-medium rounded-lg transition-colors shadow-md">
          Выход
        </button>
      </div>
      ...
      <div className="pt-20 px-6 pb-8">
        <div className="max-w-[1100px] mx-auto">
          ...
          <p className="text-gray-600">Пользователь: <span className="font-semibold text-[#2860F0]">{userName}</span></p>
        </div>
      </div>
      ...
      {isContainerHovered && (
        <div className="fixed inset-0 bg-black bg-opacity-20 z-0 transition-all duration-500 backdrop-blur-sm" />
      )}
    </div>
  );
}